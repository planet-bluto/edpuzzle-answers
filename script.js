...
function init() {
  ...
  else if ((/https{0,1}:\/\/edpuzzle.com\/assignments\/[a-f0-9]{1,30}\/watch/).test(window.location.href) || window.location.href.startsWith("https://edpuzzle.com/media/")) {
    getAssignment();
  }
...
function getAssignment(callback) {
  ...
  var url1 = "https://edpuzzle.com/api/v3/media/"+assignment_id;
